# CLAUDE.md — CLRSLean Agent Guide

This file is the single source of truth for agents working on CLRSLean.
Read it before writing or modifying any `.lean` file.

## Project overview

CLRSLean is a Lean 4 companion for CLRS (*Introduction to Algorithms*), organized
