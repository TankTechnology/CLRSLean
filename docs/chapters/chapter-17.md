...
The current chapter is a mathematical first pass.  It defers exact trailing-one
binary-counter cost, concrete dynamic-table resizing transitions, allocation,
and RAM-cost constants.
