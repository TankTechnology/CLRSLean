...
| Section 4.1 - Maximum subarray | `CLRSLean/Chapter_04/Section_04_1_Maximum_Subarray.lean` | `proved` for the exhaustive-search specification plus crossing helper | `CLRS.Chapter04.mem_nonemptySubarrays_iff`, `CLRS.Chapter04.mem_crossingSubarrays_iff`, `CLRS.Chapter04.maxCrossingSubarray_correct`, `CLRS.Chapter04.maxCrossingSubarray_isNonemptySubarray_append`, `CLRS.Chapter04.maxSubarray_correct` |
