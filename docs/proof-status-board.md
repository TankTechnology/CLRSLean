...
| Chapter 17, Sections 17.1-17.4 | Finite-prefix aggregate/accounting/potential theorems, `MULTIPOP`, executable binary-counter one-step potential bound, and abstract dynamic-table amortized wrappers are proved. | Executable multi-step counter trace theorem, concrete resize transitions, allocator/RAM cost semantics. |
