...
| Chapter 15, Sections 15.1, 15.2, and 15.4 | Rod-cutting Bellman recurrence facts, finite bottom-up table-prefix correctness, and an executable recurrence-valued rod-cutting function are proved; matrix-chain parenthesization optimality plus split-table reconstruction certificates and reconstructed-plan cost equality, and LCS certificate optimality plus table-recurrence reconstruction certificates/wrappers including matching/nonmatching recurrence consequences are also proved. | Mutable-array/memoized rod cutting, executable matrix-chain and LCS reconstruction algorithms, and optimal BST. |
...
| Chapter 15 remaining dynamic-programming targets | Mutable-array/memoized rod cutting, executable matrix-chain and LCS table/reconstruction algorithms, and optimal binary search trees. |
