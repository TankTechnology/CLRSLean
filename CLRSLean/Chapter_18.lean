...
height expression, and specification-level split/insert/delete wrappers with
split membership/search preservation and search-after-update specifications.
