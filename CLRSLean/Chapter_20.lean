...
neighbor-query-after-update specifications, direct inserted/deleted key and
old-key member-preservation corollaries, and operation-depth base/step/linear
